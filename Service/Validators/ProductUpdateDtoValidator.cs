...
public sealed class ProductUpdateDtoValidator : AbstractValidator<ProductUpdateDto>
{
    ...
    {
        // RowVersion (Concurrency) required
        RuleFor(x => x.RowVersion)
            .NotNull().WithMessage("RowVersion is required")
            .Must(rv => rv.Length > 0).WithMessage("RowVersion is required");
        ...
        // Age rules (mirrors CK_Products_Age)
        ...
        // Order limits (mirrors CK_Products_OrderLimits)
        ...
        // Return window (mirrors CK_Products_ReturnWindow)
        ...
        // Split sale (mirrors CK_Products_SplitRules)
        ...
        // Dimensions (mirrors CK_Products_Dimensions)
