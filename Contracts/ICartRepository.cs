...
public interface ICartRepository : IGenericRepository<Cart>
{
    ...
    Task<CartItem?> GetByCartProductUnitSourceAsync(int cartId, int productId, UnitLevel unitLevel, CartItemSourceType sourceType, CancellationToken ct);
    ...
    Task<bool> HasDifferentSourceTypeAsync(int cartId, CartItemSourceType sourceType, CancellationToken ct);
    Task<bool> IsProductInActiveGroupPromotionAsync(int productId, CancellationToken ct);
