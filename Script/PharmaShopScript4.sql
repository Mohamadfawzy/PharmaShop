...
CREATE TABLE Sub1Categories (
    ...
    CreatedAt DATETIME NOT NULL DEFAULT GETDATE(),
    UpdatedAt DATETIME NULL,
    CONSTRAINT FK_Sub1categories_CategoryId FOREIGN KEY (CategoryId) REFERENCES Categories(Id)
);
...
CREATE TABLE Sub2Categories (
    ...
    CreatedAt DATETIME NOT NULL DEFAULT GETDATE(),
    UpdatedAt DATETIME NULL,
    CONSTRAINT FK_Sub2categories_CategoryId FOREIGN KEY (CategoryId) REFERENCES Categories(Id)
);
...
CREATE TABLE SalesHeader (
    ...
    CONSTRAINT FK_SalesHeader_Prescriptions FOREIGN KEY (PrescriptionId)
...
CREATE TABLE Promotions (
    ...
    CONSTRAINT FK_Promotions_Pharmacies FOREIGN KEY (PharmacyId) REFERENCES Pharmacies(Id)
);
...
CREATE TABLE PromotionCategories (
    ...
    CONSTRAINT FK_PromotionCategories_Promotions FOREIGN KEY (PromotionId) REFERENCES Promotions(Id),
    CONSTRAINT FK_PromotionCategories_Categories FOREIGN KEY (CategoryId) REFERENCES Categories(Id)
);
...
CREATE TABLE PromotionUsage (
    ...
    CONSTRAINT FK_PromotionUsage_Promotions FOREIGN KEY (PromotionId) REFERENCES Promotions(Id),
    CONSTRAINT FK_PromotionUsage_Users FOREIGN KEY (UserId) REFERENCES Users(Id)
);
...
CREATE TABLE PromoCodes (
    ...
    CONSTRAINT FK_PromoCodes_Customers FOREIGN KEY (CustomerId) REFERENCES Customers(Id),
    CONSTRAINT FK_PromoCodes_Products FOREIGN KEY (ProductId) REFERENCES Products(Id),
    CONSTRAINT FK_PromoCodes_Categories FOREIGN KEY (CategoryId) REFERENCES Categories(Id)
);
...
CREATE TABLE PromoCodeUsages (
    ...
    CONSTRAINT FK_PromoCodeUsages_Customers FOREIGN KEY (CustomerId) REFERENCES Customers(Id)
);
