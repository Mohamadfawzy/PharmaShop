...
CREATE TABLE [dbo].[Orders] (
    ...
    [Status] tinyint NOT NULL CONSTRAINT [DF_Orders_Status] DEFAULT ((1)), -- 1=Pending,2=Confirmed,3=Preparing,4=OutForDelivery,5=Delivered,6=Cancelled,7=Returned
...
INCLUDE ([OrderNumber], [GrandTotal], [PaymentStatus], [StoreId]);
GO
...
INCLUDE ([OrderNumber], [CustomerId], [GrandTotal], [PaymentStatus]);
GO
...
INCLUDE ([OrderNumber], [CustomerId], [GrandTotal], [PaymentMethod]);
GO
